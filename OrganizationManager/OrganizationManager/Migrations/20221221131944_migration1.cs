        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissionWorkerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mission_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CpompanyId = table.Column<int>(type: "integer", nullable: false),
                    CompanyId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_Workers_ProjectManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupWorker", x => new { x.GroupsGroupId, x.WorkersId });
                    table.ForeignKey(
                        name: "FK_GroupWorker_Groups_GroupsGroupId",
                        column: x => x.GroupsGroupId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupWorker_Workers_WorkersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleWorker", x => new { x.RolesRoleId, x.WorkersId });
                    table.ForeignKey(
                        name: "FK_RoleWorker_Roles_RolesRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupWorker_WorkersId",
                table: "GroupWorker",
                column: "WorkersId");

            migrationBuilder.CreateIndex(
                name: "IX_Mission_WorkerId",
                table: "Mission",
                column: "WorkerId");
